...
public class HolidayBonusGui extends Application {
	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			if (e.getSource() == copyFileBtn) {
		    	...
		    	System.out.println("Programmer: Ryan Richards");
				System.exit(0);
		}
	}
	...
	public static void main(String[] args) {
		System.out.println("This application is designed to manage the sales reports for a Disney World retail dirstrict."
				+ "\nIt manages the total sales for different catagories of goods made by different stores, and\n"
				+ "calculates out the holiday bonus those stores then recive based on those sales.");
		launch(args);
	}
}